 ...
 *
 * A public install can end up with `origin=git@github.com:KLari1994/pantheon-desktop.git`.
 ...
 * against the official Pantheon downstream repo we substitute the public HTTPS
 * `ls-remote` path, which needs no auth and cannot prompt. Active update/apply
 * flows are left unchanged. Hermes runtime compatibility checks stay elsewhere.
 *
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/KLari1994/pantheon-desktop.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/klari1994/pantheon-desktop'
