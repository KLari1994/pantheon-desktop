...
const APP_NAME = process.env.HERMES_DESKTOP_APP_NAME || 'Pantheon'
...
if (IS_WINDOWS) {
  app.setAppUserModelId('com.syntropic.pantheon')
}
...
// ---------------------------------------------------------------------------
const HERMES_PROTOCOL = DEV_SERVER ? 'pantheon-dev' : 'pantheon'
/** Schemes accepted when parsing inbound URLs (dev accepts both). */
const DEEPLINK_SCHEMES = DEV_SERVER ? [HERMES_PROTOCOL, 'pantheon'] : [HERMES_PROTOCOL]
